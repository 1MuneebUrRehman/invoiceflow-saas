...
new #[Title('Edit Client')] class extends Component
{
    ...
    {
        $record = Client::findOrFail($client);
        ...
        $this->address_line1 = $record->address_line1 ?? '';
        $this->address_line2 = $record->address_line2 ?? '';
...
<div class="relative">
    ...
    <div class="mb-6 flex items-center gap-3">
        ...
        <span class="text-sm font-medium text-midnight">Edit client</span>
    </div>

    <h1 class="font-display text-3xl font-semibold tracking-tight text-midnight">Edit client</h1>
        ...
        <div class="rounded-card bg-white p-6 shadow-card ring-1 ring-midnight/5">
            ...
            <div class="grid gap-4 sm:grid-cols-2">
                <div>
                    ...
                    <input wire:model="name" type="text" class="w-full rounded-field border-0 bg-mist px-3.5 py-2.5 text-sm text-midnight ring-1 ring-midnight/15 placeholder-slate/60 focus:ring-2 focus:ring-lapis/40 focus:outline-none">
                ...
                <div>
                    ...
                    <input wire:model="company_name" type="text" class="w-full rounded-field border-0 bg-mist px-3.5 py-2.5 text-sm text-midnight ring-1 ring-midnight/15 placeholder-slate/60 focus:ring-2 focus:ring-lapis/40 focus:outline-none">
                ...
                <div>
                    ...
                    <input wire:model="email" type="email" class="w-full rounded-field border-0 bg-mist px-3.5 py-2.5 text-sm text-midnight ring-1 ring-midnight/15 placeholder-slate/60 focus:ring-2 focus:ring-lapis/40 focus:outline-none">
                ...
                <div>
                    ...
                    <input wire:model="phone" type="tel" class="w-full rounded-field border-0 bg-mist px-3.5 py-2.5 text-sm text-midnight ring-1 ring-midnight/15 placeholder-slate/60 focus:ring-2 focus:ring-lapis/40 focus:outline-none">
                </div>
                <div>
        ...
        <div class="rounded-card bg-white p-6 shadow-card ring-1 ring-midnight/5">
            ...
            <div class="grid gap-4 sm:grid-cols-2">
                <div class="sm:col-span-2">
                    ...
                    <input wire:model="address_line1" type="text" class="w-full rounded-field border-0 bg-mist px-3.5 py-2.5 text-sm text-midnight ring-1 ring-midnight/15 placeholder-slate/60 focus:ring-2 focus:ring-lapis/40 focus:outline-none">
                </div>
                <div class="sm:col-span-2">
                    <label class="mb-1.5 block text-sm font-medium text-midnight">Address line 2</label>
                    <input wire:model="address_line2" type="text" class="w-full rounded-field border-0 bg-mist px-3.5 py-2.5 text-sm text-midnight ring-1 ring-midnight/15 placeholder-slate/60 focus:ring-2 focus:ring-lapis/40 focus:outline-none">
                </div>
                <div>
                    <label class="mb-1.5 block text-sm font-medium text-midnight">City</label>
                    <input wire:model="city" type="text" class="w-full rounded-field border-0 bg-mist px-3.5 py-2.5 text-sm text-midnight ring-1 ring-midnight/15 placeholder-slate/60 focus:ring-2 focus:ring-lapis/40 focus:outline-none">
                </div>
                <div>
                    <label class="mb-1.5 block text-sm font-medium text-midnight">State / province</label>
                    <input wire:model="state" type="text" class="w-full rounded-field border-0 bg-mist px-3.5 py-2.5 text-sm text-midnight ring-1 ring-midnight/15 placeholder-slate/60 focus:ring-2 focus:ring-lapis/40 focus:outline-none">
                </div>
                <div>
                    <label class="mb-1.5 block text-sm font-medium text-midnight">Postal code</label>
                    <input wire:model="postal_code" type="text" class="w-full rounded-field border-0 bg-mist px-3.5 py-2.5 text-sm text-midnight ring-1 ring-midnight/15 placeholder-slate/60 focus:ring-2 focus:ring-lapis/40 focus:outline-none">
                </div>
                <div>
                    <label class="mb-1.5 block text-sm font-medium text-midnight">Country code</label>
                    <input wire:model="country" type="text" maxlength="2" class="w-full rounded-field border-0 bg-mist px-3.5 py-2.5 text-sm text-midnight ring-1 ring-midnight/15 placeholder-slate/60 focus:ring-2 focus:ring-lapis/40 focus:outline-none">
                </div>
            </div>
        </div>
